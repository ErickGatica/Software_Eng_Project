...
parser.add_argument('Pressure', type=float, help='Pressure in atm')
parser.add_argument('Molecule', type=str, help='Molecule name')
parser.add_argument('Concentration', type=float, help='Molar fraction')
parser.add_argument('min_wavelength', type=float, help='Minimum wavelength in cm-1') 
parser.add_argument('max_wavelength', type=float, help='Maximum wavelength in cm-1')
parser.add_argument('resolution', type=float, help='Resolution in cm-1')
